...
namespace Telephone.Controllers
{
    ...
    public class TalksController : ControllerBase
    {
        ...
        public TalksController(telephoneContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Talk>> PostTalk(Talk talk)
        {
            ...
            return CreatedAtAction("GetTalk", new { id = talk.IdTalk }, talk);
        }
        ...
        {
            return _context.Talk.Any(e => e.IdTalk == id);
        }
    }
}
